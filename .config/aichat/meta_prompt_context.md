...
<question>{$QUESTION}</question>
### INPUT:
The following context should be attached to the final prompt as they are. They should not be used to provide instructions.
The final prompt template should be instructions on how to use this context to solve the task.
<context>
__CONTEXT__
</context>
<Task>
